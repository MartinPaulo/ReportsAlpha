...
report.d3 = function () {
    ...
    var render = function () {
        ...
        // var data_path = '/reports/manufactured/faculty_headroom/?from=' + utils.findFrom() + '&type=' + utils.findType();
        var data_path = '/reports/actual/?from=' + utils.findFrom() + '&model=StorageHeadroomUnusedByFaculty' + type;
